...
public class ScoreTable implements Input.TextInputListener {
    ...
    public ScoreTable(Main game, int points) {
        ...
        _titlePos = new Vector2((Main.VIRTUAL_WIDTH - _layout.width) / 2, 618);
        _layout.setText(_game._fontP, _titleText);
        _firstScorePos = new Vector2((Main.VIRTUAL_WIDTH - _layout.width - 162) / 2, 718);
